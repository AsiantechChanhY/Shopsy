...
public class ContextMenuDialogFragment extends DialogFragment implements OnItemClickListener, OnItemLongClickListener {
    ...
    private OnMenuItemClickListener_Prem mItemClickListener;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mItemClickListener = (OnMenuItemClickListener_Prem) activity;
        } catch (ClassCastException e) {
            Log.e(TAG, activity.getClass().getSimpleName() +
                    " should implement " + OnMenuItemClickListener_Prem.class.getSimpleName());
        }
        try {
